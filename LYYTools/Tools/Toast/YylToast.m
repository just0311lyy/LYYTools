...
- (id)initWithText:(NSString *)text_{
    if (self = [super init]) {
        ...
        UIFont *font = [UIFont boldSystemFontOfSize:GetLogicFont(12)];
        CGSize textSize = [text sizeWithFont:font
                           constrainedToSize:CGSizeMake(GetLogicPixelX(400), MAXFLOAT)
...
+ (void)showWithText:(NSString *)text_{
    [YylToast showWithText:text_ duration:DEFAULT_DISPLAY_DURATION];
}

+ (void)showWithText:(NSString *)text_
            duration:(CGFloat)duration_{
    YylToast *toast = [[YylToast alloc] initWithText:text_];
...
+ (void)showWithText:(NSString *)text_
    ...
    [YylToast showWithText:text_  topOffset:topOffset_ duration:DEFAULT_DISPLAY_DURATION];
}
...
+ (void)showWithText:(NSString *)text_
    ...
    [YylToast showWithText:text_  bottomOffset:bottomOffset_ duration:DEFAULT_DISPLAY_DURATION];
}
